...
class TestGraphics(unittest.TestCase):
    ...
    def test_ellipse(self):
        ...
        plot_ellipse(np.diag((1,2)), centre=(1,1), filled=True, color='y')  # yellow filled ellipse
    ...
    def test_ellipsoid(self):
        ...
        plot_ellipsoid(np.diag((1,2,3)), centre=(1,2,3), filled=True, color='y')  # yellow filled ellipsoid

    def test_cylinder(self):
        plot_cylinder(radius=0.2, centre=(0.5,0.5,0), height=[-0.2, 0.2])
        plot_cylinder(radius=0.2, centre=(0.5,0.5,0), height=[-0.2, 0.2], filled=True, resolution=5, color='red')
# ---------------------------------------------------------------------------------------#
